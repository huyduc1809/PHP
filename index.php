...
<body class="home">
    ...
    <!-- banner part starts -->
    <section class="hero bg-image" data-image-src="images/img/food2.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Cửa hàng thức ăn nhanh </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span>1. </span>Chọn Quán ăn</h4>
                    </div>
                    <!-- end:Step -->
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">Sự lựa chọn dễ dàng cho bữa ăn nhanh và ngon miệng</p>
                                    ...
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="product-name">' . $r['slogan'] . '</div>
                                             <a href="xemchitiet.php?res_id=' . $r['rs_id'] . ' & d_id=' . $r['d_id'] . '" class="btn  pull-right">Xem chi tiết</a> 
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Lựa chọn Quán ăn </h3>
                                <p>Chúng tôi luôn sao kê các danh sách món ăn
                                    từng mọi nơi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <p>We"ve got your covered with menus from over 345
                                delivery restaurants online.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Tự qua lấy hàng hoặc ship tới</h3>
                            <p>Đặt món mà bạn muốn và sau đó thực hiện thao tác
                                shipping</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">@2023 - Team Pixel</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row top-footer">
                <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                    <a href="#"> <img src="images/logoko.png" alt="Footer logo" class="img-footer"> </a> <span>Order

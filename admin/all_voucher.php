                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Danh sách các voucher giảm giá</h4>
                                </div>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                // This code block will execute if the query doesn't return any results.
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr>
                                                                                                <td>' . $i . '</td>
																								<td>' . $rows['id_voucher'] . '</td>
																								<td>' . $rows['Ten'] . '</td>
																								<td>' . $rows['GiaTriGiamGia'] . 'đ</td>
																								
																								
																								
																								
																							
																									 <td><a href="delete_voucher.php?voucher_del=' . $rows['id_voucher'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_voucher.php?voucher_upd=' . $rows['id_voucher'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
                                                }
                                            }

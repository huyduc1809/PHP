...
if (isset($_POST['submit'])) {
    if (empty($_POST['c_name'])) {
        ...
        // If the query returns any rows, set an error message that the category already exists.
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Thêm danh mục
                                        Quán ăn</h4>
                                </div>
                                ...
                                <table id="myTable" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($query) == 0) {
                                            echo '<tr><td colspan="4"><center>No Categories Data!</center></td></tr>';
                                        } else {
                                    ...
                                    <td>' . $rows['date'] . '</td>
                                    <td>
                                        <a href="delete_category.php?cat_del=' . $rows['c_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 

    ...
    foreach ($_SESSION["cart_item"] as $item) {
        ...
        if ($_POST['submit']) {
            if ($_POST['mod'] == 'COD') {
                ...
                $SQL = "insert into users_orders(u_id,title,quantity,price, rs_id) values('" . $_SESSION["user_id"] . "','" . $item["title"] . "','" . $item["quantity"] . "','" . $item["price"] . "','" . $res_id . "')";

                $ktramavocher = " update chitiet_voucher set TrangThai=0 where u_id='" . $_SESSION["user_id"] . "' and id_voucher= '" . $_SESSION["voucher_code"] . "'";

                mysqli_query($db, $ktramavocher);
                    ...
                    <div class="container">
                        ...
                        <li class="nav-item"><a href="registration.php" class="nav-link active">Đăng Ký</a> </li>';
                                    ...
                                    if (isset($_SESSION["voucher_code"])) {
                                        ...
                                        $SQLGG = "SELECT GiaTriGiamGia FROM voucher WHERE id_voucher ='" . $_SESSION["voucher_code"] . "'";
                                        $kqgiamgia = mysqli_query($db, $SQLGG);
                                        $ketqua = mysqli_fetch_assoc($kqgiamgia);

                                        if ($ketqua) {
                                            $giaTriGiamGia = $ketqua['GiaTriGiamGia'];
                                            // Sử dụng $giaTriGiamGia để tiếp tục xử lý logic
                                        }
                                    }
                                    //if user is login
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-color">
                                                                    <strong>
                                                                        <?php echo $item_total - $giaTriGiamGia . "đ"; ?></strong>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>

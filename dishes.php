...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Chọn Quán ăn</a>
                    </li>
        ...
        ?>
        <section class="inner-page-hero bg-image" data-image-src="images/img/food4.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <label class="control-label">Chọn
                                    voucher</label>
                                <form action="dishes.php?res_id=<?php echo $_GET['res_id'] ?>" method="POST">
                                    <select name="res_name" class="form-control custom-select">
                                        ...
                                        $ssql = "select id_voucher from chitiet_voucher where u_id= $id and TrangThai=1";

                                        $res = mysqli_query($db, $ssql);
                                        while ($row = mysqli_fetch_array($res)) {
                                            echo ' <option value="' . $row['id_voucher'] . '"> ' . $row['id_voucher'] . '</option>';
                                        }

                                        ?>
                                    </select>
                                    <input type="submit" name="apply_voucher" value="Áp mã">
                                </form>
                                <p>Ưu đãi Free Ship </p>
                                <a href="checkout.php?res_id=<?php echo $_GET['res_id'] ?>" class="btn theme-btn btn-lg button">Đặt
                                    Hàng</a>
                            </div>
                        </div>
                                    ...
                                    <div class="food-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                                ...
                                                <input type="submit" class="btn theme-btn" style="width:10rem;" value="Thêm vào giỏ hàng" /></form>
                                                <form action="your_like.php">
                                                    <input type="submit" class="btn theme-btn" style="width:10rem; margin-top: 5px" value="Yêu thích" />
                                                </form>
                                            </div>

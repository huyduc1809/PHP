                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td data-column="status">
                                                            ...
                                                            ?>
                                                                <button type="button" class="btn btn-info" style="font-weight:bold;">Đang
                                                                    xét duyệt</button>
                                                            <?php
                                                            }
                                                            if ($status == "in process") { ?>
                                                                <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span>Đang
                                                                    vận
                                                                    chuyển!</button>
                                                            <?php
                                                            }
                                                            if ($status == "closed") {
                                                            ?>
                                                                <button type="button" class="btn btn-success"><span class="fa fa-check-circle" aria-hidden="true">Đã
                                                                        giao
                                                                        hàng</button>
                                                            <?php
                                                            }
                                                            ...
                                                            if ($status == "rejected") {
                                                            ?>
                                                                <button type="button" class="btn btn-danger"> <i class="fa fa-close"></i>Đã
                                                                    hủy</button>
                                                            <?php
                                                            }
                                                            ?>
